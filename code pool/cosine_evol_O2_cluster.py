...
from core.cosine_evol_lib import *
...
if sys.platform == "linux":
    ...
    # Hdir_BigGAN = join(scratchdir, "Hessian", "H_avg_1000cls.npz")  #TODO: the path to the Hessian Files on the cluster
    # Hdir_fc6 = join(scratchdir, "Hessian", "Evolution_Avg_Hess.npz")  #TODO: the path to the Hessian Files on the cluster
    sys.path.append("/home/binxu.w/Visual_Neuro_InSilico_Exp") #TODO: the path to the codebase you are running on the cluster
...
if __name__=="__main__":
    ...
    from core.utils.GAN_utils import upconvGAN, loadBigGAN, BigGAN_wrapper
    from core.utils.Optimizers import HessAware_Gauss_DC, CholeskyCMAES
