...
# parameters parsing
# 
NUM_OF_RUNS_PER_POP_SIZE = 3
NUM_OF_RUNS_PER_IMAGE = 5
#%%
# set main fynction
if __name__=="__main__":
    ...
    exp_result_root = r"C:\Data\cosine\insilico_experiments\Most_active_vs_random\results\rotated%s" % date_time_str
                ...
                for score_method in metric_name:
                    ...
                    for gen_rerun_id in range(NUM_OF_RUNS_PER_IMAGE):
                        ...
                        codes_all, scores_all, actmat_all, generations, last_gem_img, last_gem_img_maske, best_imgs, best_imgs_RF_masked, best_scores =\
                            ...
                            titlestr =title_str, steps=100, RFresize=True, corner=pading_size, imgsize=img_size, RF_mask=fitdict_random["fitmap"], save_plot="full")
                        # 
            ...
            for score_method in metric_name:
                ...
                for gen_rerun_id in range(NUM_OF_RUNS_PER_IMAGE):
                    ...
                    codes_all, scores_all, actmat_all, generations, last_gem_img, last_gem_img_maske, best_imgs, best_imgs_RF_masked, best_scores =\
                        ...
                        titlestr =title_str, steps=100, RFresize=True, corner=pading_size, imgsize=img_size, RF_mask=fitdict_most["fitmap"], save_plot="full")
                    # 
                    figh = visualize_popul_act_evol(actmat_all, generations, targ_actmat, titlestr=title_str)
                    print_fig(figh, exp_result_root, expriment_meta_data_df, output_type= "popul_act_evol",**trial_param_dict)                                               
                # clear the memory
