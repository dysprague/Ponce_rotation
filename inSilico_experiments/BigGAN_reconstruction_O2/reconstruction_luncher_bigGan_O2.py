...
if sys.platform == "linux":
    ...
    refimgdir = r"/n/scratch3/users/a/ala2226/insilico_experiments/big_data_set"
    sys.path.append(r"/home/ala2226/Cosine-Project") #TODO: the path to the codebase you are running on the cluster

else:
    exp_result_main_root = r"C:\Data\cosine\insilico_experiments\BigGAN_reconstruction_test1"
...
if __name__=="__main__":
    ...
    for imgid in range(len(refimgnms)):
        ...
        for pop_resampling_id in range(NUM_OF_RUNS_PER_POP_SIZE):
            ...
            fitdict = fr_estimatir(scorer, G, unit_tsridx_dict, layer_name, input_size,show_fig=False, gan_name=gan_name)
                ...
                for gen_rerun_id in range(NUM_OF_RUNS_PER_IMAGE):
                    ...
                    codes_all, scores_all, actmat_all, generations, last_gem_img, last_gem_img_maske, best_imgs, best_imgs_RF_masked, best_scores =\
                        run_evol(scorer, objfunc, optimizer, G, reckey=layer_name, savedir=exp_result_root,
                                ...
                                RF_mask=fitdict["fitmap"], save_plot="full", save_data=True, init_code = init_code)
                    # 
