...
if sys.platform == "linux":
    save_data_main_root = r"/n/scratch3/users/a/ala2226/different_nets_experiment_preprocessed"
    data_root = r"/n/scratch3/users/a/ala2226/different_nets_experiment_090523"
    sys.path.append(r"/home/ala2226/Cosine-Project") 
    init_img_path = os.path.join(r"/n/scratch3/users/a/ala2226/different_nets_experiment_090523", r"init_img.jpg")
    RF_path = r"/n/scratch3/users/a/ala2226/different_nets_experiment_090523/rf_filters"
else:
